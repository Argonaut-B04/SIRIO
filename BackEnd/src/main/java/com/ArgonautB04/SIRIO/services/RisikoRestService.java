...
public interface RisikoRestService {
    ...
    /**
     * fungsi untuk mengambil list semua risiko
    ...
    /**
     * fungsi untuk menghapus risiko tertentu
     * pada database
     * @param idRisiko
     */
     ...
     * @param idRisiko
     * @return mengubah status risiko
     * menjadi nonaktif pada database
     */
    Risiko nonaktifkanRisiko(int idRisiko);

    /**
     * Mengubah jenis object dari risikodto
     * menjadi risiko
     * @param risiko
     * @param risikoDTO
    ...
    /**
     * fungsi untuk mengecek apakah terdapat risiko
     * tertentu pada database
     * @param risiko
     * @return true apabila terdapat risiko,
     * false jika tidak
     */

    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <Link to="/rencanaPemeriksaan" className="btn btn-primary">Tabel Rencana Pemeriksaan</Link>
                <Link to="/kantorCabang" className="btn btn-primary">Tabel Kantor Cabang</Link>

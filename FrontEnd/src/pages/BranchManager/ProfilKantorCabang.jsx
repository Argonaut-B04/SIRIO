...
export default class KantorCabang extends React.Component {
    ...
    render() {
        if (AuthenticationService.getRole() !== "Branch Manager") {
            return (
                <Redirect to={{
                    pathname: "/error",
                    state: {
        ...
        return (
            ...
            <SirioMainLayout contentLoading={this.state.contentLoading} loadingBody={this.state.loadingBody}>
                <ProfilKantorCabang contentFinishLoading={this.contentFinishLoading} contentStartLoading={this.contentStartLoading} changeLoadingBody={this.changeLoadingBody} />
            </SirioMainLayout>
